...
@Service
public class OfferServiceFilters implements OfferService{

  private static final Logger log = LoggerFactory.getLogger(OfferServiceFilters.class);
  ...
  public OfferListDto pick(ClaimDto claim) {
    ...
    List<Long> priceProfrole = priceProfroleService.getPriceGroupsByProfroleId(List.of(professionId.longValue()));
