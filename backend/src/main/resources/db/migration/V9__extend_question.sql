...
INSERT INTO questions (
    id, type, question_text, reference_type, is_required,
    short_title, code, position
) VALUES
      (1, 'reference', 'Выберите регион:',    'regions',     TRUE,
       'Регион:', 'regions', 1),
      (2, 'reference', 'Выберите профессию:', 'professions', TRUE,
       'Профессия', 'professions', 2),
